...
const refreshCaptcha = async () => {
  ...
  try {
    ...
    // Silent fail for captcha refresh
  } finally {
        ...
        <form class="space-y-6" @submit.prevent="handleSubmit">
          ...
          <div v-if="needsCaptcha" class="space-y-2 animate-fade-in">
            ...
            <div class="flex gap-3">
              ...
              />
              <div
                class="relative h-12 w-32 bg-surface border border-white/10 cursor-pointer overflow-hidden group"
          ...
          <div
            v-if="isLocked"
            class="flex items-center gap-3 text-orange-500 text-sm bg-orange-900/10 border border-orange-900/20 p-4 animate-fade-in"
          >
