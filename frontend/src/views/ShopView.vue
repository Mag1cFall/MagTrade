<template>
  <div class="min-h-screen bg-background text-primary selection:bg-accent selection:text-white overflow-x-hidden">
    <div class="pt-20 pb-8 px-4 md:px-8 border-b border-white/5 bg-black/80 backdrop-blur-3xl sticky top-0 z-30">
      <div class="container mx-auto flex flex-col lg:flex-row justify-between items-end gap-6">
        <div class="space-y-2">
          <div class="flex items-center gap-2">
            ...
            <span class="text-[10px] font-mono tracking-[0.3em] text-accent uppercase">秒杀商店</span>
          </div>
          <h1 class="text-3xl md:text-5xl font-black tracking-tighter text-white leading-none">
            MAG<span class="text-accent">STORE</span>
          </h1>
          <p class="text-secondary tracking-[0.2em] uppercase text-[10px] font-medium">限时抢购 // 先到先得</p>
        </div>
    ...
    <div class="container mx-auto px-4 md:px-8 py-12">
      <div v-if="loading" class="flex flex-col items-center justify-center py-40 gap-6">
        ...
        <span class="text-xs font-mono tracking-widest text-secondary animate-pulse">加载中...</span>
      </div>
        ...
        >
          ...
          >
            <div class="relative aspect-square bg-surface-light overflow-hidden flex flex-col">
              ...
              <div class="w-full h-full p-4 flex items-center justify-center relative overflow-hidden">
                ...
                <div v-else class="text-5xl opacity-20 transition-all duration-500 group-hover:opacity-40 relative z-10">
              ...
              <div class="absolute top-2 left-2 z-20 flex flex-col gap-1">
                <div v-if="item.status === 1" class="flex items-center gap-1 px-2 py-0.5 bg-accent text-white text-[8px] font-bold uppercase animate-pulse">
          ...
          <div class="mt-3 px-1">
            <h3 class="text-sm font-bold text-white truncate group-hover:text-accent transition-colors">
            ...
            <div class="flex items-center justify-between mt-2">
              <div class="text-[10px] text-tertiary line-through">¥{{ item.product?.original_price }}</div>
