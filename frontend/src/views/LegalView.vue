...
<template>
  <div class="min-h-screen bg-background pt-24 px-6 md:px-12 pb-20">
    <div class="max-w-4xl mx-auto">
      <button
        class="text-sm text-secondary hover:text-white flex items-center gap-2 mb-8 uppercase tracking-widest transition-colors group"
        @click="router.push('/')"
      >
      ...
      <div class="bg-surface border border-white/5 p-8 md:p-12 rounded-lg relative overflow-hidden">
        ...
        <div v-if="activeTab === 'terms'" class="space-y-8 animate-fade-in">
          ...
          <section class="space-y-4">
            ...
            <p class="text-secondary leading-relaxed">
              By accessing and using MagTrade ("the Platform"), you agree to comply with and be
              bound by these Terms of Service. The Platform leverages the Obsidian Velocity Protocol
              to ensure high-frequency trading capabilities. Users must acknowledge that network
              latency may vary based on geographical location.
            </p>
          </section>
          ...
          <section class="space-y-4">
            ...
            <p class="text-secondary leading-relaxed">
              MagTrade employs advanced edge computing to minimize latency. However, you acknowledge
              that:
              <br />a) Flash sale outcomes are determined by millisecond-level timestamps. <br />b)
              Network jitter on the client side is beyond our control. <br />c) Use of automated
              bots not authorized by our API protocols may result in immediate account suspension.
            </p>
          </section>
          ...
          <section class="space-y-4">
            ...
            <p class="text-secondary leading-relaxed">
              All transactions are final. The Platform ensures atomic swaps for inventory management
              using Lua scripts on Redis clusters. In the event of a system rollback, refunds will
        ...
        <div v-if="activeTab === 'privacy'" class="space-y-8 animate-fade-in">
          ...
          <section class="space-y-4">
            ...
            <p class="text-secondary leading-relaxed">
              We collect minimal data necessary for transaction processing and anti-fraud analysis.
              This includes IP addresses, device fingerprints, and transaction logs. Our AI Anomaly
              Detector analyzes this data in real-time to prevent sybil attacks.
            </p>
          </section>
          ...
          <section class="space-y-4">
            ...
            <p class="text-secondary leading-relaxed">
              All sensitive data is encrypted using AES-256 standards at rest and TLS 1.3 in
              transit. We do not store raw credit card numbers; all payments are processed through
              secure third-party gateways compliant with PCI-DSS.
            </p>
          </section>
        </div>
        ...
        <div v-if="activeTab === 'support'" class="space-y-8 animate-fade-in">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div
              class="p-6 bg-surface-light border border-white/5 rounded hover:border-accent/50 transition-colors cursor-pointer group"
            >
              <h3 class="font-bold text-white mb-2 group-hover:text-accent">Live Chat</h3>
              <p class="text-sm text-secondary">
                Connect with our AI agents instantly for order inquiries.
              </p>
            </div>
            <div
              class="p-6 bg-surface-light border border-white/5 rounded hover:border-accent/50 transition-colors cursor-pointer group"
