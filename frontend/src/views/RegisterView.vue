    ...
    <div class="w-full md:w-1/2 flex items-center justify-center p-8 relative z-10 bg-background border-r border-white/5">
      ...
      <div class="w-full max-w-md space-y-8">
        <div>
          ...
          <p class="text-secondary text-sm tracking-widest uppercase">Create Your Digital Identity</p>
        </div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div class="space-y-2">
            <label class="text-xs text-secondary uppercase tracking-widest">Email Verification</label>
          ...
          <div class="space-y-2">
            <label class="text-xs text-secondary uppercase tracking-widest">Verification Code</label>
            <input 
          ...
          >
            ...
            <span v-else class="relative z-10 group-hover:translate-x-1 transition-transform">Initialize Account</span>
        ...
        <div class="mt-8 text-center pt-8 border-t border-white/5">
          ...
          <button @click="router.push('/login')" class="text-white text-sm font-bold border-b border-white hover:text-accent hover:border-accent transition-colors ml-2 uppercase tracking-wider">
            Login Here
          </button>
        </div>
      </div>
