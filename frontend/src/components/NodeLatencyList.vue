  ...
  <div class="node-latency-list bg-black/40 backdrop-blur border border-white/10 rounded-xl p-6">
    ...
    <div class="space-y-3">
      <div
        v-for="node in nodes"
        :key="node.id"
        class="flex items-center justify-between text-sm group cursor-pointer hover:bg-white/5 p-2 rounded transition-colors"
      >
        ...
        <div class="flex items-center gap-4">
          ...
          <span class="font-mono font-bold w-12 text-right" :class="getLatencyColor(node.latency)"
